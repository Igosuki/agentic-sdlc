...
model: sonnet
allowed-tools: Bash(${CLAUDE_SKILL_DIR}/scripts/setup-checks.sh)
---

# Setup

Machine check:
!`${CLAUDE_SKILL_DIR}/scripts/setup-checks.sh`
