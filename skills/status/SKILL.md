...
allowed-tools: Bash(${CLAUDE_SKILL_DIR}/../dispatch/scripts/workers.py *), Bash(${CLAUDE_SKILL_DIR}/../dispatch/scripts/next-tasks.py *), Bash(${CLAUDE_SKILL_DIR}/../dispatch/scripts/settings.sh *)
---
...
!`${CLAUDE_SKILL_DIR}/../dispatch/scripts/workers.py 2>&1 || true`

## Dispatch queue

!`${CLAUDE_SKILL_DIR}/../dispatch/scripts/next-tasks.py 2>&1 || true`
